...
def libraryRepoUrl = System.getenv("JENKINS_SHARED_LIBRARY_GIT_REPO_URL")
def libraryCredentialsId = System.getenv("JENKINS_SHARED_LIBRARY_GIT_CREDENTIALS_ID")

if(libraryRepoUrl?.trim() && libraryCredentialsId?.trim()) {
